                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-sm text-gray-500 max-w-sm leading-relaxed">
                            Engineering intelligent systems for growing organizations. We approach automation as system architecture — not isolated scripts.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a
                                    href="mailto:shoebfaizan71@gmail.com"
                                    className="text-sm text-gray-500 hover:text-white transition-colors duration-200"
                                >
                            ...
                            <li>
                                <a
                                    href="https://www.linkedin.com/in/mohammad-shoeb-faizan/"
                                    target="_blank"
                            ...
                            <li>
                                <a
                                    href="https://github.com/Mohammad-Shoeb-Faizan"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-white transition-colors duration-200"
                                >
